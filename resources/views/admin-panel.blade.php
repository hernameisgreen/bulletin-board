                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="inline-block w-2/4">
                        ...
                        <div class="fact-blocks mt-3 flex gap-x-4">
                            <div class="bg-yellow-300 h-24 w-22 rounded-md p-2 text-center">Users Registered:<br><span class="text-indigo-600">{{Auth::user()->created_at->format('Y/m/d')}}</span></div>
